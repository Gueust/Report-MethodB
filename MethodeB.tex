...
Exemple de citation: \cite{behm1999meteor}
...
\begin{axiom}[Axiome de la réunion] Cet axiome définit, à partir d'un ensemble A, un nouvel ensemble $\bigcup A$ contenant les éléments des éléments de A. Avec l'axiome de la paire on peut définir l'union avec $A \cup B = \bigcup {A, B}$.
\begin{align}
...
\begin{axiom}[Axiome du choix] Cet axiome définit que pour tout ensemble $A$ il existe un ensemble auquel appartiennent exactement tous les sous-ensembles de $A$.
\begin{align}
\forall A \ \exists P \ \forall B \ [B \in P \iff \forall C \, (C \in B \Rightarrow C \in A)] 
\end{align}
\end{axiom}
