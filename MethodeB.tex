...
\end{itemize}
\ \\
Les paramètres sont listés entre parenthèses après le nom de la machine. Il existe également d'autres clauses, certaines seront vues dans la suite et le reste est réservé à des utilisations spécifiques.
\iffalse
...
\begin{longtable}{ll} lr $\leftarrow$ creer\_Livre $\doteq$ \tabularnewline some stuff \end{longtable}
\indent \textbf{PRE}
\begin{longtable}{ll} & LIVRE\ \textbackslash \ livre $\neq$ $\emptyset$ \end{longtable}
