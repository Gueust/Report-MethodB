...
Il y a donc deux types de vérification en B :
– la correction (ou validité) syntaxique (type-checking ) qui porte
sur la vérification des types ;
– la vérification axiomatique ou sémantique (obligation de
preuves ).
