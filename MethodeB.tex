...
\item un langage~;
\item un ensemble d'outils autour de l'Atelier B (développé par la société ClearSy\footnote{Voir \url{http://www.methode-b.com/}}).
\end{itemize}
~
...
La méthode B repose d'abord sur la logique du premier ordre. Une définition formelle des règles de remplacement sont données sur \url{http://www.pps.univ-paris-diderot.fr/~kesner/enseignement/master1/gl/hoare-4.pdf} et sur  \url{http://fr.wikipedia.org/wiki/Logique_de_Hoare}.
...
Les règles d'inférences de Hoare permettent la construction de programmes devant être appelés avec certaines préconditions et garantissant certaines postconditions.
